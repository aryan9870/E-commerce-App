  ...
  return (
    <div className="pt-20 mx-20 max-md:pt-10 max-md:mx-5 text-gray-600 tracking-wider">
      <div className="">
        ...
        <div className="flex items-center justify-center max-md:flex-col max-md:gap-10">
          <div className="w-1/2 max-md:w-full">
            <img className="w-2/3 max-md:w-full" src={assets.aboutImage} alt="" />
          </div>
      ...
      <div className="py-20 flex justify-center items-center flex-col gap-5 max-md:items-start">
        ...
        <div>
          <div className="flex gap-2 items-center bg-gray-200 rounded-md shadow-sm">
            ...
            />
            <button className="bg-black text-white py-2 px-5 rounded-r-md cursor-pointer">Subscribe</button>
          </div>
        </div>
      </div>
    </div>
